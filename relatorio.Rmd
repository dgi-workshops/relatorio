...
# Configura as imagens criadas para terem resolução alta
...
bolsa_familia_2010_regiao %>%
  ggplot(aes(x = as.factor(regiao), y = total_repasse/10^6, fill=as.factor(regiao))) +
...
bolsa_familia_2010_regiao %>%
  ggplot(aes(x = as.factor(regiao), y = media_familias, fill=as.factor(regiao))) +
  geom_bar(position="dodge", stat="identity") +
